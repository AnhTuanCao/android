    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String image = uri!=null ? uri.toString() : user.getImage();
                String gender = "";
                if(tmp == btnMale.getId()) gender = "male";
                else gender = "female";
                if (gender.isEmpty() || name.isEmpty() || image.isEmpty()  || date.compareToIgnoreCase("dd/MM/yyyy") == 0) {
        ...
        btnDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(EditActivity.this,R.style.DialogTheme,
